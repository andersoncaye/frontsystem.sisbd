...
if (isset($_POST['search_now'])){
    ...
    if ($_POST['search_now'] == 'create1') {
        $r = $connectionDataBase->select("CREATE INDEX i_idCidade_usuario on usuario(idCidade)");
    } else if ($_POST['search_now'] == 'drop1') {
        $r = $connectionDataBase->select("DROP INDEX i_idCidade_usuario");
    }else if ($_POST['search_now'] == 'create2') {
        $r = $connectionDataBase->select("CREATE INDEX i_resumo_dia on resumo_dia(idUsuario)");
    }else if ($_POST['search_now'] == 'drop2') {
        $r = $connectionDataBase->select("DROP INDEX i_resumo_dia");
    }
